                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                            ...
                            <a class="nav-link" href="list-movies.php"><i class="fas fa-caret-square-right"></i>&nbsp;&nbsp;Movies</a>
                            <a class="nav-link" href="list-genres.php"><i class="fas fa-caret-square-right"></i>&nbsp;&nbsp;Genres</a>
                            <a class="nav-link" href="list-actors.php"><i class="fas fa-caret-square-right"></i>&nbsp;&nbsp;Actors</a>
                            <a class="nav-link" href="list-roles.php"><i class="fas fa-caret-square-right"></i>&nbsp;&nbsp;Roles</a>
                            <a class="nav-link" href="list-directors.php"><i class="fas fa-caret-square-right"></i>&nbsp;&nbsp;Directors</a>
                            <a class="nav-link" href="list-writers.php"><i class="fas fa-caret-square-right"></i>&nbsp;&nbsp;Writers</a>
                            <a class="nav-link" href="list-productions.php"><i class="fas fa-caret-square-right"></i>&nbsp;&nbsp;Productions</a>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6">
                                    <div class="card bg-dark text-white mb-4">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="list-movies.php">Edit</a>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="card bg-secondary text-white mb-4">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="list-genres.php">Edit</a>
                                            <div class="small text-white"><i class="fas fa-edit"></i></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="card bg-primary text-white mb-4">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="list-actors.php">Edit</a>
                                            <div class="small text-white"><i class="fas fa-edit"></i></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="card bg-info text-white mb-4">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="list-roles.php">Edit</a>
                                            <div class="small text-white"><i class="fas fa-edit"></i></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="card bg-danger text-white mb-4">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="list-directors.php">Edit</a>
                                            <div class="small text-white"><i class="fas fa-edit"></i></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="card bg-warning text-white mb-4">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="list-writers.php">Edit</a>
                                            <div class="small text-white"><i class="fas fa-edit"></i></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="card bg-success text-white mb-4">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="list-productions.php">Edit</a>
                                            <div class="small text-white"><i class="fas fa-edit"></i></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- </div>
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="card bg-light text-dark mb-4">
                                                ...
                                                <div class="card-footer bg-dark d-flex align-items-center justify-content-between">
                                                    <a class="small text-white stretched-link" href="index.php">Edit</a>
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="card bg-light text-dark mb-4">
                                                ...
                                                <div class="card-footer bg-dark d-flex align-items-center justify-content-between">
                                                    <a class="small text-white stretched-link" href="movies-list.php">Edit</a>
